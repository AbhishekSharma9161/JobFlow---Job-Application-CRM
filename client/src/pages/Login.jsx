...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[var(--bg)]">
      ...
      {/* ── MOBILE HERO BANNER (visible only on < lg) ── */}
      <div className="lg:hidden bg-gradient-to-br from-brand-600 via-brand-700 to-purple-800 px-6 pt-10 pb-8 relative overflow-hidden">
        {/* Background grid */}
        ...
        <div className="relative">
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-white font-extrabold text-lg">JobFlow</span>
          </div>
          {/* Headline */}
          ...
          <p className="text-white/70 text-sm mb-5">
            Manage applications, follow-ups &amp; your entire pipeline — all in one place.
          </p>
          {/* Feature pills */}
          <div className="flex flex-wrap gap-2">
            {[["📋","Applications"],["📊","Analytics"],["🔔","Reminders"],["🗂️","Kanban"]].map(([icon, label]) => (
              <span key={label} className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-xs font-semibold">
                {icon} {label}
              </span>
            ))}
          </div>
      ...
      {/* ── DESKTOP LEFT PANEL (visible only on lg+) ── */}
        ...
        <div className="relative">
          ...
          >
            ...
            >
              ...
              <TextMarquee height={40} speed={2} className="font-semibold text-white min-w-[200px]">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8">
        <div className="w-full max-w-md bg-blue-200/40 backdrop-blur-xl border border-white/40 rounded-2xl shadow-xl px-6 sm:px-8 py-8 sm:py-10 animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold shadow-md hover:scale-[1.02] transition"
            >
